...
Для описания свойств и взаимоотношений значений, и строгих рассуждений о них математики ещё полтора века назад [Frege1879] разработали формализованный язык, называемый **исчислением предикатов**. Десятилетия теоретических исследований и практического использования исчисления предикатов позволили убедиться в его корректности и достаточной выразительности, понять все его возможности и ограничения; выработался современный удобный синтаксис. 

Когда говорят о чисто-функциональных (purely functional) языках программирования, часто упоминают, что у них есть “математическая основа“. Что имеется в виду и какие преимущества это даёт?
...
1. Выразительность исчисления предикатов гарантирует, что все свойства программ на чисто-функциональных языках программирования, не завиящие от устройства компилятора и модели вычисления, можно сформулировать. Мы можем сформулировать требование, что функция `sort` всегда правильно сортирует, а функция `groupBy` правильно группирует. Более того, мы можем сформулировать и что такое полнота спецификации: убедившись, что две любые программы, соответствующие данной спецификации, эквивалентны, мы доказываем что не упустили из виду каких-то редких пограничных случаев.
...
Не смотря на все эти преимущества, чисто-функциональные неоптимально подходят для решения задач, не сводящихся напрямую к преобразованию данных — в первую очередь создания интерактивных приложений и распределённых систем. Именно их определяющий признак — избегание прямых операций с объектами — вынуждает в этих случаях прибегать к использованию замысловатой машинерии (монадические трансформеры) работы с объектами, “не называя их вслух”. Для таких задач более приспособлены современные мультипарадигменные языки, такие как Kotlin, Rust и Scala, позволяющие оперировать напрямую не только данными, но и объектами.

Тщательное размежевание объектов и данных — необходимое условие чтобы мультипарадигменным языкам стали в полной мере применимы пункты (1) и (2).
