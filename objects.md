...
§ Смешение команд и функций: Крупнейший источник избыточной сложности
---------------------------------------------------------------------
...
<center>* * *</center>
Пусть команда `copy(source, destination)` возвращает количество скопированных файлов. Рассмотрим вот такую программу:
```kotlin
...
§ Радикальное решение: Чисто-функциональные языки
-------------------------------------------------
