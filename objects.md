...
Сложно найти в истории языков программирования что-нибудь нанесшее больший ущерб отрасли, чем непонимание фундаментально разной природы объектов и данных и бесчисленные попытки расчесать их под одну гребёнку.

Все мы описываем материальный мир в терминах объектов, таких как яблоко или электрон. Свойства объектов, такие как вес или название, не являются сами по себе материальными объектами. Допустим, мы взвесили некое яблоко — теперь у нас есть информация: `apple1.wight = 93g`. Упоминающееся тут яблоко — материальный объект, а «93 грамма» — это значение. Такие штуки абстрактные как «93 грамма» называются “данными”, в единственном числе — “значение”.

Разумеется, окружающий мир можно воспринимать в терминах картин и ощущений, а рассуждать о нём “интуитивно”, как это делают животные. Однако чтобы сделать возможными чёткие инструкции и строгие рассуждения, необходимо провести условные границы и разложить мир на идеализированные единицы моделирования — объекты. В зависимости от предметной области это могут быть, например, яблоки и груши, ордера и квитанции, поезда и станции, или электроны и фотоны. Канонический пример объекта в программировании — изменяемая переменная (= ячейка памяти), содержащая изменяемое целочисленное значение. 

Математика и чисто-функциональные (purely functional) языки программирования оперируют только значениями. Значениями в математическом, платоническом смысле — такими, как например, число 2.
