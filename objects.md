...
По этому пути уже попытались пойти разработчики языка Rust, однако их подход (— переделывать уже построенное здание, мы так делать не будем, мы будем строить здание с нуля на надёжном фундаменте).
