...
§ Зачем разделять объекты и данные?
-----------------------------------
...
Как распространить вышеописанные преимущества функциональных языков программирования на языки мультипарадигменные?

Необходимым условием для этого является тщательное азмежевание объектов и данных. (тбц)

§ Деконструкция ООП
-------------------

По пути в явного различения данных и объектов уже пошли разработчики языка Rust, однако retrofitting существующих практик 


переделывать уже построенное здание, мы так делать не будем, мы будем строить здание с нуля на надёжном фундаменте).
