...
Несмотря на все эти преимущества, чисто-функциональные языки посредственно подходят для решения задач, не сводящихся напрямую к преобразованию данных — в первую очередь для создания интерактивных приложений и распределённых систем. Именно их определяющий признак — избегание прямых операций с объектами — вынуждает в этих случаях прибегать к использованию замысловатой машинерии (монадические трансформеры) работы с объектами, “не называя их вслух”. Для таких задач более приспособлены современные мультипарадигменные языки, такие как Kotlin, Rust и Scala, позволяющие оперировать напрямую не только данными, но и объектами.
