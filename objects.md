...
Существует такой класс языков программирования — чисто-функциональные языки, в рамках этих языков напрямую можно оперировать только и исключительно данными. Две программы на таких языках мы будем называть эквивалентными, если при одинаковых входных данных они производят одинаковые выходящие, а свойства программ мы будем называть эстенсиональными, если они инвариантны относительно эквивалентности. Исчисление предикатов позволяет выразить любое экстенсиональное свойство программ. Мы можем сформулировать требование, что функция `sort` всегда правильно сортирует, а функция groupBy правильно группирует. Не факт, что любое свойство любой программы легко будет доказать или опровергнуть, но у нас есть гарантия, что мы можем его сформулировать. Более того, логика первого порядка позволяет убедиться, что спецификация полна, и мы не упустили из виду каких-то редких пограничных случаев.
