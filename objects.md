...
К сожалению, ничего из этого в данный момент не доступно для императивных языков программирования в полной мере, а ведь именно это в конечном итоге и является ключом к написанию надёжного софта. Условия корректности каждой функции не выписывают не из-за лени, а потому, что их всё равно никто не будет читать. А вот хорошо структурированный, литературно написанный и “очевидно” корректный-по-построению код — лучшая спецификация и лучшая документация самому себе*. Обеспечение возможности писать такой код я вижу центральной задачей при проектировании языков программирования.
