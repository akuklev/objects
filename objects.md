...
Когда-то Tony Hoare назвал Null References “ошибкой на миллиард долларов”. В истории языков программирования есть кое-что обходящееся, вероятно, ещё дороже: игнорирование фундаментальной разницы между данными и объектами.
...
Возможность Описания Критериев Корректности
-------------------------------------------
...
* * *
К программам на императивных языках программирования, оперирующих не только данными, но ещё и объектами, мы тоже полезно предьявлять требования, например отсутствие deadlocks и race conditions. Но как и на каком языке их формулировать? И откуда у нас уверенность, что нет ещё каких-нибудь полезных свойств, в выполнении которых не прочь бы убедиться? Где взять такой язык, чьей выразительности заведомо хватит для формулирования любых требований, и чьи свойства позволяют убедиться, что мы ничего не забыли?

Добавление в исчисление предикатов возможности рассуждать ещё и об объектах —  предмет активных исследований (см. Adjoint logic), и на данный момент у нас не только исчерпывающего формального инструментария, но и устоявшегося единого неформального способа думать об объектах.

Ниже я продемонстрирую, как шаг за шагом добавить в чисто-функциональный язык программирования императивные элементы, не теряя возможости описывать свойства программ и доказывать их. В примерах я буду использовать вымышленный чисто-функциональный язык с синтаксисом на основе Котлина.

Даже если вы не намереваетесь заниматься формальной верификацией и вообще когда-либо пользоваться таким языком программирования, понимание его устройства поможет лучше понять многие моменты, касающиеся параллелизации, out-of-order execution, а также на некоторые тонкости, возникающие в многопоточном программировании.
