...
Чисто-функциональные языки программирования характерны тем, что оперируют напрямую только и исключительно данными, для рассуждений о которых имеется развитый математический инструментарий.
