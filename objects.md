...
Как выясняется, первым условием для этого является тщательное размежевание объектов и данных. Ниже я продемонстрирую, как шаг за шагом добавить в чисто-функциональный язык программирования императивные элементы, не теряя возможости строго описывать свойства программ. Начав с надёжного “чисто-функционального” фундаменты мы реконструием мультепарадигменный язык и “переизобретём” как нам думать об объектах, эффектах и взаимодействующих процессах понятным и непротиворечивым образом. В примерах я буду использовать вымышленный чисто-функциональный язык с синтаксисом на основе Kotlin'а — по целому ряду причин именно Kotlin наилучшим образом подходит для этой задачи.
