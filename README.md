...
Объекты очень понятны интутивно, но, как мы многократно убедимся ниже, весьма сложны концептуально. Значения гораздо проще концептуально, но нетренированный занятиями абстрактной математикой мозг не имеет соответствующей интуиции и упорно пытается воспринимать их как объекты.
...
Давайте обсудим распространённые разновидности объектов с конкретными примерами, чтобы иметь перед глазами материал для дальнейших рассуждений.
