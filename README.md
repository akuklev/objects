...
Самая распространённая в прикладном программировании разновидность объектов — так называемые ресурсы: файлы, очереди (message queues), базы данных и т.д. Ресурс это объект, к которому возможен доступ со стороны процессов, не владеющих им всецело. На практике это означает возможность создавать и передавать объекты-аксессоры к ресурсу с теми или иными возможностями (capabilities).
